                                ...
                                <div class="box">
                                    ...
                                    <div class="col-lg-8 col-md-12 mx-md-auto">
                                        <ul class="hotelInfo mx-auto">
                                            ...
                                            <li><a href="{{url('/packageDetails')}}" class="details"> <i class="fa fa-car icon" aria-hidden="true"></i> <br>Economy/Coach flights and </span> <strong class="right service">Per Person includes flights + hotels </strong> </a></li>
