                                    ...
                                    <div class="col-lg-4 col-md-12 mx-md-auto">
                                        ...
                                        <div class="col-lg-8 col-md-12 mx-md-auto">
                                            <ul class="hotelInfo mx-auto">
                                                ...
                                                <li><a href="{{url('/booking')}}"> <input type="submit" style="width:30%; background:#f9be37; color:#fff;" value="Add to Cart" class="btn right"></a></li>
                                            </ul>
                                        </div>  
                          </div>
